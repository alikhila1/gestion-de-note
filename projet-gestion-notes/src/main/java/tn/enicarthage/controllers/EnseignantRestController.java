...
public class EnseignantRestController {
	...
	public EnseignantRestController(IEnseignantService enseignantServiceStub) {
		iEnseignantService = enseignantServiceStub;
	}
	...
	void ajouterEnseignant(@RequestBody Enseignant e,@PathVariable("idG") int idG) throws MessagingException {
		...
		iEnseignantService.ajouterEnseignant(e,idG);
