...
public class EtudiantEtrangerRestController {
	...
	void ajouterEtudiantEtranger(@RequestBody Etudiant_etranger e, @PathVariable("idGroupe") long idGroupe)
	...
	public Optional<Etudiant_etranger> getEtudiantEtrangerLogged(@RequestParam String username,
