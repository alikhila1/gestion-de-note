...
public class AbsenceRestController {
	...
	public List<Object[]> getNombreAbsencesParEtudiantParMatiereAndGroupe(@PathVariable Long idMatiere,
			@PathVariable Long idGroupe) {
		return iAbsenceService.getNombreAbsencesParEtudiantParMatiereAndGroupe(idMatiere, idGroupe);
	}
	
	@GetMapping("/nombre-absences-par-matiere/{idEtudiant}")
	public List<Object[]> getNombreAbsencesParMatiere(@PathVariable Long idEtudiant) {
	    return iAbsenceService.getNombreAbsencesParMatiere(idEtudiant);
	}
}
